...
namespace KurumsalWeb.Controllers
{
    public class YorumController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "YorumId,AdSoyad,Eposta,İcerik,Onay,BlogId")] Yorum yorum)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "YorumId,AdSoyad,Eposta,İcerik,Onay,BlogId")] Yorum yorum)
        {
            if (ModelState.IsValid)
            {
